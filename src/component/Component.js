...
const drawDynamic = require('./helpers/drawDynamic');
const proxy = require('../proxy');
const toInlineStyle = require('../utils/toInlineStyle');
const queueReady = require('./helpers/queue-ready');
const queueDraw = require('./helpers/queueDraw');
const extendInstance = require('./helpers/extendInstance');
const removeAllAttributes = require('../utils/removeAllAttributes');
const h = require('../vdom/h');
const loadLocal = require('./helpers/loadLocal');
const localMixin = require('./helpers/localMixin');
